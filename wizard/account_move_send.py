...
class AccountMoveSend(models.TransientModel):
    ...
    l10n_ke_checkbox_oscu = fields.Boolean(
        ...
        default='_get_default_l10n_ke_etims_vscu_enable',
    ...
    def _compute_l10n_ke_show_checkbox_oscu(self):
        for wizard in self:
            wizard.l10n_ke_show_checkbox_oscu = any(self._get_default_l10n_ke_etims_vscu_enable(move) for move in wizard.move_ids)

    def _get_default_l10n_ke_etims_vscu_enable(self, move):
        return not move.l10n_ke_oscu_receipt_number
    ...
    def _call_web_service_before_invoice_pdf_render(self, invoices_data):
        ...
        for invoice, invoice_data in invoices_data.items():
            if invoice_data.get('l10n_ke_oscu') and self._get_default_l10n_ke_etims_vscu_enable(invoice):
